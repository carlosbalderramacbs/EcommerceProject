				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a href="#" ><span class="icon label-before fa fa-mobile"></span>Telefono 4444444 CBBA</a>
								</li>
							</ul>
						</div>
								...
								@auth
									@if(Auth::user()->utype=='ADM')
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												<li class="menu-item" >
													<a title="Panel" href="/panel">Panel Administrador</a>
												</li>
												<li class="menu-item">
									...
									@else
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												<li class="menu-item" >
													<a title="Panel" href="/panel">Panel</a>
												</li>
												<li class="menu-item">
													<a href="{{route('logout')}}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Cerrar Sesion</a>
												</li>
									...
									<div class="wrap-contact-detail">
										<ul>
											...
											<li>
												...
												<p class="contact-txt">44367713 Ferreteria Julio's</p>
											</li>
											<li>
							...
							<div class="wrap-footer-item">
								...
								<div class="item-content">
									<div class="wrap-hotline-footer">
										...
										<b class="phone-number">44447713 - (+591) 60701086	</b>
									</div>
								</div>
							</div>
