                    ...
                    <div class="panel-body">
                        ...
                        <form class="form-horizontal" enctype="multipart/form-data" wire:submit.prevent="addProduct">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" readonly placeholder="slug Producto" readonly class="form-control input-md" wire:model="slug"/>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Precio del Prodcuto" class="form-control input-md"wire:model="precio_regular"/>
                            ...
                            {{-- <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="text" placeholder="Unidad de Medida" class="form-control input-md"wire:model="medida"/>                                    
                                </div>
                            </div> --}}
