            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif 
                        <form class="form-horizontal"  method="POST"  wire:submit.prevent="updateProvider">

                            <div class="form-group" >                            
                                <label class="col-md-4 control-label">Nombre del proveedor</label>
                                <div class="col-md-4">
                                    <input type="text" id="name" name="name" placeholder="nombre proveedor" class="form-control input-md" wire:model="nombre"/>
                            ...
                            <div class="form-group" >                            
                                ...
                                <div class="col-md-4">
                                    <input type="text" id="name" name="name" placeholder="teléfono" class="form-control input-md" wire:model="telefono"/>
