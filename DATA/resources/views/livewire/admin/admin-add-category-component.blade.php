            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif 
                        <form class="form-horizontal"  method="POST"  wire:submit.prevent="storeCategory">
                            @csrf
                            <div class="form-group" >                            
                                <label class="col-md-4 control-label">Nombre Categoria</label>
                                <div class="col-md-4">
                                    <input type="text" id="name" name="name" placeholder="nombre categoria" class="form-control input-md" wire:model="nombre"  wire:keyup="generateslug"/>
