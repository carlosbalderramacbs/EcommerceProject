<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administra tus sesiones activas y cierra sesion de dispositivos no conocidos') }}
    </x-slot>

    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600">
            {{ __('Si es necesario puedes hacer click en el boton de abajo para cerrar la sesion en todos tus dispositivos.') }}
        </div>
                        ...
                        <div class="ml-3">
                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    @else
                                        {{ __('Dispositivos recientes') }} {{ $session->last_active }}
                                    @endif
                                </div>
                            </div>
                        </div>
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Porfavor ingresa tu contraseña.') }}
